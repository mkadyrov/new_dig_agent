...
class AbonentComplaintNewScreen extends React.Component {
  ...
  render() {
    return (
      <View style={styles.container}>
        <CustomHeader navigation={this.props.navigation} title='Новая жалоба' />
        <ScrollView>
...
export default AbonentComplaintNewScreen;
